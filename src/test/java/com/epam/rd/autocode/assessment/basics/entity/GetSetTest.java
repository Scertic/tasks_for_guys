...
class GetSetTest {
    ...
    void testOrder() {
        ...
        verifier.verify("startTime", new Date(), new Date(new Date().getTime() + 500));
        verifier.verify("endTime", new Date(), new Date(new Date().getTime() + 500));
        verifier.verify("price", BigDecimal.ZERO, BigDecimal.ONE);
    }
    ...
    void testEmployee() {
        ...
        verifier.verify("dateOfBirth", new Date(), new Date(new Date().getTime() + 500));
    }
}
